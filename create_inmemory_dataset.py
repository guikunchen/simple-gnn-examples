...
# create a toy data (a graph sample)
def toy_data(num_nodes, num_node_features, num_edges):
...
class PyGToyDataset(InMemoryDataset):
    ...
    def process(self):
        ...
        data_list = [toy_data(num_nodes=32, num_node_features=3, num_edges=42) for _ in range(100)]
